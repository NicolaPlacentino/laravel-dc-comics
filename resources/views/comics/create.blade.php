            ...
            <div class="row">
                <div class="col px-4 mb-3">
                    ...
                    <div class="d-flex">
                        <div class="me-5">
                            ...
                            <input type="text" name="title" id="title" class="mb-1">
                        </div>
    
                        <div class="me-5">
                            <label for="series" class="d-block">Serie</label>
                            <input type="text" name="series" id="series" class="mb-1">
                        </div>
                    </div>

                    <div>
                        <label for="thumb" class="d-block">Immagine</label>
                        <input type="url" name="thumb" id="thumb" class="mb-1 w-75">
                    </div>
                    ...
                    <div class="me-5">
                        ...
                        <input type="text" name="type" id="type" class="mb-1">
                    </div>
                </div>
                ...
                <div class="col px-4 mb-3">
                    <div>
                        ...
                        <textarea name="description" id="description" class="mb-1 w-100"></textarea>
                    </div>       
                    <div>
                        <label for="artists" class="d-block">Artisti</label>
                        <textarea name="artists" id="artists" class="mb-1 w-100"></textarea>
                    </div>   
                    <div>
                        <label for="writers" class="d-block">Scrittori</label>
                        <textarea name="writers" id="writers" class="mb-1 w-100"></textarea>
                    </div>           
                </div>
